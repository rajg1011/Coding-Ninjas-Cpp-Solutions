...
and Step Size (W), you need to convert all Fahrenheit values from Start to End at
...
Now add 13 to Fahrenheit Value at each step until you reach 119 in this case. You may or may
not exactly land on the end value depending on the steps you are taking.
